...
import (
	...
	"github.com/DataTunerX/finetune-controller/controllers"
)
...
func main() {
	...
	logging.NewZapLogger(os.Getenv("LOG_LEVEL"))
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8582e760.datatunerx.io",
	...
	if err = (&controllers.FinetuneReconciler{
		Log:       logging.ZLogger,
